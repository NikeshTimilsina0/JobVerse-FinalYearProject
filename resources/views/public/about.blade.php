...
@section('content')
<!-- Hero Header Section -->
<div class="bg-white border-bottom py-5 mb-5 text-center">
    <div class="container py-3">
        <span class="badge bg-primary-subtle text-primary border border-primary-subtle px-3 py-2 rounded-pill fw-bold text-uppercase small mb-3">Our Mission</span>
        ...
        <div class="col-lg-6">
            <div class="p-4 bg-white border rounded shadow-sm">
                <div class="d-flex gap-3 mb-4">
                    <div class="p-3 bg-primary-subtle rounded text-primary h4 mb-0"><i class="bi bi-shield-check"></i></div>
                    <div>
                ...
                <div class="d-flex gap-3 mb-4">
                    <div class="p-3 bg-success-subtle rounded text-success h4 mb-0"><i class="bi bi-person-workspace"></i></div>
                    <div>
                ...
                <div class="d-flex gap-3">
                    <div class="p-3 bg-info-subtle rounded text-info h4 mb-0"><i class="bi bi-code-square"></i></div>
                    <div>
